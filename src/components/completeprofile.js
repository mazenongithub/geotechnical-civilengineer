...
class CompleteProfile extends Component {
    ...
    render() {
        const formaction = `${process.env.REACT_APP_SERVER}/api/${this.props.match.params.clientid}/updateclientregister`
        ...
        <div className="register-half">First Name<br/><input type="text" className="regular-field" name="firstname" onChange={event=>{this.handlefirstname(event.target.value)}} value={this.getfirstname()} /></div>
         ...
         <div className="register-full">Client ID <br/><input type="text" className="regular-field" name="clientid" onFocus={event=>{this.checkclientid(event)}} onBlur={event=>{this.checkclientid(event)}} value={this.getclientid()} onChange={event=>{this.handleclientid(event.target.value)}} /></div>
         {this.showclienturl()}
